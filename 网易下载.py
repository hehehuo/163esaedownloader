...
#getApi接口函数
def getapi(a,b):
	request = urllib.request.Request("https://daiwei.site/netease"+ a +urllib.parse.quote(b))
...
def search(a):
	...
	if jlist['code']==200:
		...
		mainmenu()
#歌单批量下载函数
#分享TottenhamHotspurs钟爱我刺创建的歌单「《NBA2K20》手机版歌单」: http://music.163.com/playlist/3194981757/1749681077/?userid=4909090782 (来自@网易云音乐)
def dwgd(link):
	global max
	global now
